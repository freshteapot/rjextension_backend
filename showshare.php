...
"select * from sharelog where username =" . $user['id'] . " order by time DESC limit 100;");
$result = mysql_query("select * from sharelog, followers where followers.followerid = " . $user['id'] . " and log.username = " . $user['id'] . " limit 10;"
?>
<html>
<head>
	 <style type="text/css">
